...
<span class="d-block p-2 bg-dark text-white"style="font-size:30px;text-align:center">最新公告</span>
    ...
    <img src="img\1-1.svg" class="img-rounded" style="width:300px ;height:300px">
      ...
      <div class="jumbotron"style="background-color:white;width:device-width;height:300px">
          ...
          <h2 style="font-size: 17px;color:#5B5B5B;" class="text-center"><br>  系统更新后，后勤相关的操作得以在网上实行。欢迎广大师生通过该系统对后勤管理与服务工作进行监督、评价，需要维修时通过系统进行保修，我们会及时处理。<br></h2> </div>
      </div>
       </div><!-- row -->
      </div><!-- contanier -->
      <!-- 分割线2 -->
    ...
    <div class="col-sm-4" style="background-color:lavender; height:5px"></div>
      ...
      <div class="jumbotron"style="background-color: white;width:device-width;height:300px">
          <h1 style="font-size: 45px;color:#5B5B5B;font-weight: bolder" class="text-center">维修保障</h1>
                <h2 style="font-size: 17px;color:#5B5B5B;" class="text-center"><br>所有维修人员均有一定的维护经验，经过正规的上岗培训，我集团均进行了严格个人资料登记与管理，维护期间均负责到人，全程记录便于后期的问题查找。</h2></div>
      </div>
       <div class="col-sm-4" style="background-color:white; height:5px">
             <img src="img\1-2.svg" class="img-rounded" style="width:300px ;height:300px"></div>
       </div>
       </div>
       <!-- 分割线3 -->
       <div class="container-fluid">
    ...
    <img src="img\1-3.svg" class="img-rounded" style="width:300px ;height:300px">
      ...
      <div class="jumbotron"style="background-color: white;width:device-width;height:300px">
          ...
          <h2 style="font-size: 17px;color:#5B5B5B;" class="text-center"><br> 校园内的小白龙进行了新一轮的升级，保证每一辆车都能实现刷卡功能，严格规定司机的行车路线，正确规范司机的行车习惯，给同学带来更好的乘车体验。</h2> </div>
      </div>
       </div><!-- row -->
      </div><!-- contanier -->
      <!-- 分割线4 -->
  ...
  <thead>
    <tr>
      <th scope="col"><h4>工作动态</h> <!-- 这里不要改成h4，否则会把接下来的图片放到第二行 -->
      <a href="#"><img src="img\more.gif" class="float-right"></a></div></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td> <a class="card-text" href="#" style="color:#5B5B5B">
      <img src="img\link.gif" >我校幼儿园举行“放飞梦想 快乐成长”六一儿童节文艺汇演活动<br></a>
    </td>
    </tr>
    <tr>
      <td> <a class="card-text"href="#" style="color:#5B5B5B">
     <img src="img\link.gif" >  后勤服务集团召开4月份中心主任例会 <br></a></td>
    </tr>
    <tr>
       <td><a class="card-text"href="#" style="color:#5B5B5B" >
     <img src="img\link.gif" > 后勤服务集团召开5月份中心主任例会 <br></a></td>
    </tr>
    <tr> <td> <a class="card-text"href="#" style="color:#5B5B5B">
     <img src="img\link.gif" > 四川省高校后勤协会成都第二片区2019年第一会议在我校召开 <br></a></td></tr>
     <tr> <td> <a class="card-text"href="#" style="color:#5B5B5B">
     <img src="img\link.gif" >  能源服务中心尹协忠等四人获评动专会2017-2018年度个人先进称号<br></a></td></tr>
  </tbody>
</table>
    </div>
  ...
  <thead>
    <tr>
      <th scope="col"><h4>党建之窗</h> <!-- 这里不要改成h4，否则会把接下来的图片放到第二行 -->
      <a href="#"><img src="img\more.gif" class="float-right"></a></div></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td> <a class="card-text" href="#" style="color:#5B5B5B">
      <img src="img\link.gif" >后勤服务集团党总支获评2017-2018年度四川省高校后勤思想政治工作先进党组织<br></a>
    </td>
    </tr>
    <tr>
      <td> <a class="card-text"href="#" style="color:#5B5B5B">
     <img src="img\link.gif" >  后勤服务集团党总支举办“廉政文化史”专题讲座  <br></a></td>
    </tr>
    <tr>
       <td><a class="card-text"href="#" style="color:#5B5B5B" >
     <img src="img\link.gif" > 后勤服务集团退休党支部走进战旗村 <br></a></td>
    </tr>
    <tr> <td> <a class="card-text"href="#" style="color:#5B5B5B">
     <img src="img\link.gif" > 后勤服务集团召开中心组学习（扩大）会议 <br></a></td></tr>
     <tr> <td> <a class="card-text"href="#" style="color:#5B5B5B">
     <img src="img\link.gif" >  后勤服务集团党总支组织观看反腐倡廉影片《反贪风暴4》<br></a></td></tr>
  </tbody>
</table>
</div>
       </div><!-- row -->
  ...
  <thead>
    <tr>
      <th scope="col"><h4>热点专题</h> <!-- 这里不要改成h4，否则会把接下来的图片放到第二行 -->
      <a href="#"><img src="img\more.gif" class="float-right"></a></div></th>
    </tr>
  </thead>
  </table>
      ...
      <div class="col-sm-3" style="height:125px">
      <img src="img\zt2.png" ></div>
      <div class="col-sm-3" style="height:125px">
      <img src="img\zt3.png" ></div>
      <div class="col-sm-3" style="height:125px">
      <img src="img\zt3.png" ></div>
      </div>
      </div>
