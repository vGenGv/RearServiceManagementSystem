...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
		<a class="navbar-brand " href="#">
			<img alt="brand" src="img\logo.png" style="width: 80x; height: 80px; display: inline;">
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown active">
					<a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 党建之窗 </a>
				...
				<li class="nav-item dropdown active">
					<a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 新闻中心 </a>
					<div class="dropdown-menu ">
				...
				<li class="nav-item dropdown active">
					<a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 服务指南 </a>
					<div class="dropdown-menu">
	...
	<span class="d-block p-2 bg-dark text-white" style="font-size: 30px; text-align: center">最新公告</span>
	<!-- 四块巨幕 -->
	<!-- 分割线 -->
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-4" style="background-color: white; height: 5px">
				<img src="img\1-1.svg" class="img-rounded" style="width: 300px; height: 300px">
			</div>
			<!-- Main component for a primary marketing message or call to action -->
			<div class="col-sm-8" style="background-color: white;">
				<div class="jumbotron" style="background-color: white; width: device-width; height: 300px">
					<h1 style="font-size: 45px; color: #5B5B5B; font-weight: bolder" class="text-center">掌上后勤</h1>
					<h2 style="font-size: 17px; color: #5B5B5B;" class="text-center">
						<br> 系统更新后，后勤相关的操作得以在网上实行。欢迎广大师生通过该系统对后勤管理与服务工作进行监督、评价，需要维修时通过系统进行保修，我们会及时处理。<br>
					</h2>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-8" style="background-color: white;">
				<!-- Main component for a primary marketing message or call to action -->
				<div class="jumbotron" style="background-color: white; width: device-width; height: 300px">
					<h1 style="font-size: 45px; color: #5B5B5B; font-weight: bolder" class="text-center">维修保障</h1>
					<h2 style="font-size: 17px; color: #5B5B5B;" class="text-center">
			...
			<div class="col-sm-4" style="background-color: white; height: 5px">
				<img src="img\1-2.svg" class="img-rounded" style="width: 300px; height: 300px">
			</div>
		</div>
	</div>
	<!-- 分割线3 -->
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-4" style="background-color: white;">
				<img src="img\1-3.svg" class="img-rounded" style="width: 300px; height: 300px">
			</div>
			<!-- Main component for a primary marketing message or call to action -->
			<div class="col-sm-8" style="background-color: white;">
				<div class="jumbotron" style="background-color: white; width: device-width; height: 300px">
					<h1 style="font-size: 45px; color: #5B5B5B; font-weight: bolder" class="text-center">车辆服务</h1>
					<h2 style="font-size: 17px; color: #5B5B5B;" class="text-center">
						<br> 校园内的小白龙进行了新一轮的升级，保证每一辆车都能实现刷卡功能，严格规定司机的行车路线，正确规范司机的行车习惯，给同学带来更好的乘车体验。
					</h2>
				</div>
			</div>
		</div>
					...
					<thead>
						<tr>
							<th scope="col"><h4>
									...
									<a href="#">
										<img src="img\more.gif" class="float-right">
									</a></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							<td><a class="card-text" href="#" style="color: #5B5B5B">
									<img src="img\link.gif"> 能源服务中心尹协忠等四人获评动专会2017-2018年度个人先进称号<br>
								</a></td>
						</tr>
					</tbody>
				</table>
	...
	<div class="container-fluid" style="height: 5px">
		...
		<div class="row">
			<div class="col-sm-5 bg-dark">
				<span class="d-block bg-dark text-white" style="font-size: 5px; text-align: left">版权声明 | 网站地图 | 友情链接 | 媒体专区 | <img src="img\ga.gif" style="height: 20px">
				</span> <span class="d-block bg-dark text-white" style="font-size: 5px; display: inline">关于我们 | 15766456049 |四川省成都市二仙桥东三路一号成都理工大学6A502</span>
			</div>
			...
			<div class="col-sm-4 bg-dark text-white">
				<p style="font-size: 5px;">
					<span class="d-block bg-dark text-white" style="font-size: 5px; text-align: right">土拨鼠股份有限公司©版权所有|蜀ICP备05026980号</span> <span class="d-block bg-dark text-white"
						style="font-size: 5px; text-align: right">邮政编码：610059|联系方式|<a href="#">
							<img class="rounded float-right" src="img\facebook.PNG" style="height: 36px">
						</a>
						<a href="#">
							<img class="rounded float-right" src="img\wechat.PNG" style="height: 36px">
						</a>
						<a href="#">
							<img class="rounded float-right" src="img\weibo.PNG" style="height: 36px">
						</a></span>
			</div>
		</div>
