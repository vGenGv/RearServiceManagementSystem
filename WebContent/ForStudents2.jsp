...
<title>CDUT后勤管理系统-学生入口</title>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark " >
  ...
  <a class="dropdown-item" href="Suggestion.jsp">建言献策</a>
    ...
    <a class="nav-link text-center" href="ForStudents.jsp"style="font-size:18px ;color:white">提交报修单</a>

    <a class="nav-link text-center active" href="#"style="font-size:18px ;color:white">报修历史记录</a>
  ...
  <thead>
    <tr>
      <th scope="col"><h4>报修历史记录</h> <!-- 这里不要改成h4，否则会把接下来的图片放到第二行 --></th>
    </tr>
  </thead>
  <tbody>
    <tr>
