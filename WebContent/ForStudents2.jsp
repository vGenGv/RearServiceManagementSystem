		...
		<div class="row">
			<div class="col-sm-2 bg-dark">
				<nav class="nav flex-column">
					...
					<a class="nav-link text-center" href="ForStudents.jsp"
						style="font-size: 18px; color: white">提交报修单</a> <a
						class="nav-link text-center active" href="#"
						style="font-size: 18px; color: white">报修历史记录</a>
			...
			<div class="col-sm-10 bg-grey">
				<table class="table">
					<thead>
						<tr>
							<th scope="col"><h4>报修历史记录</h4> <!-- 这里不要改成h4，否则会把接下来的图片放到第二行 --></th>
						</tr>
					</thead>
					<tbody>
