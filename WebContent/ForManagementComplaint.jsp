...
<title>CDUT后勤管理系统-建维修部门管理入口</title>
 <style>
	  .carousel-inner img {
		  width: 100%;
		  height: 100%;
 ...
 <button type="button" class="btn btn-dark dropdown-toggle" style="font-size:18px ;color:white" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="#">学生投诉</a>
  ...
  <thead>
    <tr>
      <th scope="col"><h4>投诉栏</h4> <!-- 这里不要改成h4，否则会把接下来的图片放到第二行 --></th>
    </tr>
  </thead>
  </table>
                 <ul class="list-group">
                ...
                <div class="media-left" >
                  ...
                  <h5 class="media-heading">Gray He</h5>
