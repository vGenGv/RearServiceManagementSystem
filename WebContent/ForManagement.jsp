...
<title>CDUT后勤管理系统-维修部门管理入口建言献策</title>
 <style>
	  .carousel-inner img {
		  width: 100%;
		  height: 100%;
  ...
  <a class="dropdown-item" href="Suggestion.jsp">建言献策</a>
    ...
    <a class="nav-link text-center active" href="#"style="font-size:18px ;color:white">人员信息管理</a>
 ...
 <button type="button" class="btn btn-dark dropdown-toggle" style="font-size:18px ;color:white" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  ...
  <thead>
    <tr>
      <th scope="col"><h4>维修人员信息管理</h4> <!-- 这里不要改成h4，否则会把接下来的图片放到第二行 --></th>
    </tr>
  </thead>
  <tbody>
    <tr>
