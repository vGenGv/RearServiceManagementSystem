...
<title>CDUT后勤管理系统-学生入口</title>
 <style>
  ...
  <a class="dropdown-item" href="Suggestion.jsp">建言献策</a>
    ...
    <a class="nav-link text-center active" href="#"style="font-size:18px ;color:white">提交报修单</a>

    <a class="nav-link text-center " href="ForStudents2.jsp"style="font-size:18px ;color:white">报修历史纪录</a>
</nav>
      </div>
      ...
      <table class="table">
       <thead>
    <tr>
      <th scope="col"><h4>报修单</h4> <!-- 这里不要改成h4，否则会把接下来的图片放到第二行 --></th>
    </tr>
  </thead>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4" style="color:red">电话号码*</label>
      <input type="email" class="form-control" id="inputEmail4" placeholder="电话号码">
    </div>
    <div class="form-group col-md-6">
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="inputState" style="color:red">故障类型*</label>
  ...
  <button type="submit" class="btn btn-secondary"  style="width:100px">提交</button>
  </div>
</form>
      </div>
