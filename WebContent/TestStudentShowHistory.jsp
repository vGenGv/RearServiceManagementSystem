	...
	<%
		for(int i=0;i<lenth;i++){
			...
			if(processInfo.equals("审核通过")){
				out.print("<td><a href='StudentServlet?method=complete&RepairID="+id+"'>已完工  </a><a href='TestComplain.jsp?RepairID="+id+"'>投诉</a></td></tr>");
			}else if(processInfo.equals("审核中")){
				out.print("<td><a href='StudentServlet?method=delete&RepairID="+id+"'>撤回  </a><a href='TestComplain.jsp?RepairID="+id+"'>投诉</a></td></tr>");
			}else if(processInfo.equals("已完工")){
				if(comment==null){
					out.print("<td><a href='TestComment.jsp?RepairID="+id+"'>评价  </a><a href='TestComplain.jsp?RepairID="+id+"'>投诉</a></td></tr>");
				}else{
					out.print("<td><a href=''>查看评价  </a><a href='TestComplain.jsp?RepairID="+id+"'>投诉</a></td></tr>");
				}
			}else{out.print("<td><a href='TestComplain.jsp?RepairID="+id+"'>投诉</a></td></tr>");}
		}
	%>
	</tbody>
</table>
