...
<body>
	...
	<div class="container-fluid">
		<table class="table">
			<thead>
				<tr>
					<th scope="col"><h4>建言献策</h4> <!-- 这里不要改成h4，否则会把接下来的图片放到第二行 --></th>
				</tr>
			</thead>
		</table>
		<form>
				...
				<li class="list-group-item">
					<div class="media">
						...
						<div class="media-body">
							...
							<p>2019-6-04-12:00</p>
							<p>The maintainers are quite friendly, the whole repairing
								process is convenient thanks to the new systme. By the way,
								these pages are awesome！ Love it so much!</p>
						</div>
					</div>
				</li>
				<li class="list-group-item">
	...
	<nav aria-label="Page navigation example">
		<ul class="pagination justify-content-center">
			...
			<li class="page-item"><a class="page-link" href="Suggestion2.jsp">2</a></li>
			<li class="page-item"><a class="page-link" href="Suggestion3.jsp">3</a></li>
			<li class="page-item"><a class="page-link" href="Suggestion2.jsp">Next</a></li>
		</ul>
	</nav>
	...
	<!-- 留言板部分 -->
	<div class="container-fluid" style="height: 183px">
		<!-- Main component for a primary marketing message or call to action -->
		<div class="row">
			...
			<div class="col-sm-6 bg-light">
				<form>
					<div class="form-group">
						<label for="exampleFormControlTextarea1">您的留言：</label>
						<textarea class="form-control" id="FormText" rows="5"></textarea>
					</div>
				</form>
			</div>
			<div class="col-sm-4 bg-light">
				<button type="button" class="btn btn-success bottom">提交</button>
			</div>
