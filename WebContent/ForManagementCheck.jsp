...
<title>CDUT后勤管理系统-维修部门管理入口</title>
 <style>
  ...
  <a class="dropdown-item" href="Suggestion.jsp">建言献策</a>
    ...
    <a class="nav-link text-center " href="ForManagement.jsp "style="font-size:18px ;color:white">人员信息管理</a>

    <a class="nav-link text-center active" href="#"style="font-size:18px ;color:white">审核报修单</a>
 ...
 <button type="button" class="btn btn-dark dropdown-toggle" style="font-size:18px ;color:white" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  ...
  <div class="dropdown-menu">
    ...
    <a class="dropdown-item" href="ForManagementWorkerCom.jsp">维修工人问题上报</a>
  </div>
</nav>
      </div>
  ...
  <button type="button" class="btn btn-secondary">通过</button>
  <button type="button" class="btn btn-secondary ">无法通过</button>
</div></td>
    </tr>
  </tbody>
</table>
